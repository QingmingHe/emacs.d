...
#+begin_src emacs-lisp
(defun org-at-heading-line-not-in-heading-p ()
  (and
...
(defun my-move-to-next-line(&optional arg try-vscroll)
  (interactive "^p\np")
  (next-line arg try-vscroll)
  (when (org-at-heading-line-not-in-heading-p)
    (beginning-of-visual-line)
    (end-of-line)))

(defun my-move-to-prev-line(&optional arg try-vscroll)
  (interactive "^p\np")
...
(define-key evil-normal-state-map (kbd "j") 'my-move-to-next-line)
(define-key evil-normal-state-map (kbd "k") 'my-move-to-prev-line)
#+end_src
