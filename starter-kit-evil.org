...
;; distinguish between evil earch and isearch
(setq isearch-evil-search-p nil)
(defadvice evil-search-incrementally (around distinguish-evil-search activate)
  (setq isearch-evil-search-p t)
  ad-do-it
  (setq isearch-evil-search-p nil))
