...
#+begin_src emacs-lisp
(setq my-english-words-list (concat starter-kit-dir "dict/english-words.txt"))
...
#+BEGIN_SRC emacs-lisp
(setq bmkp-bmenu-state-file (concat starter-kit-dir ".emacs-bmk-bmenu-state.el"))
#+END_SRC
...
#+begin_src emacs-lisp
(defvar starter-kit-eim-py-bank
  (expand-file-name
   "eim-user-bank.txt"
   (if dropbox-root
       (expand-file-name "dict" dropbox-root)
     (concat starter-kit-dir "dict")))
