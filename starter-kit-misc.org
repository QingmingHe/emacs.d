...
;; (custom-set-faces
;;  '(mode-line
;;    ((t (:background "#073642" :foreground "cyan" :inverse-video nil
;;                     :underline nil :slant normal :weight normal))))
;;  '(mode-line-inactive
;;    ((t (:background "#073642" :foreground "#657b83" :inverse-video nil
;;                     :box nil :underline nil :slant normal :weight normal)))))
#+END_SRC
