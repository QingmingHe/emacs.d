...
+ Original hungry delete is incompatible with evil mode. To overwrite
  [[help:evil-delete-backward-char-and-join][evil-delete-backward-char-and-join]], [[help:evil-local-set-key][evil-local-set-key]] is used.
...
(eval-after-load 'evil
  `(evil-global-set-key 'insert [backspace] 'hungry-delete-backward))
