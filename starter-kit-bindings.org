...
#+begin_src emacs-lisp
(key-chord-define-global ";a" 'select-window-1)
(key-chord-define-global ";b" 'select-window-2)
(key-chord-define-global ";c" 'select-window-3)
(key-chord-define-global ";d" 'select-window-4)
(key-chord-define-global ";e" 'select-window-5)
(key-chord-define-global ";f" 'select-window-6)
(key-chord-define-global ";;" 'select-window-0)
#+end_src
