...
;;;;; isearch
   `(isearch ((t (:foreground ,zenburn-cyan :weight bold :background ,zenburn-bg+2))))
   `(isearch-fail ((t (:foreground ,zenburn-fg :background ,zenburn-red-4))))
   `(lazy-highlight ((t (:foreground ,zenburn-blue :weight bold :background ,zenburn-bg-05))))
...
;;;;; hl-line-mode
   `(hl-line-face ((,class (:background ,(if (window-system)
                                             zenburn-bg-05
                                           zenburn-bg+1)))
                   (t :weight bold)))
   `(hl-line ((,class (:background ,(if (window-system)
                                        zenburn-bg-05
                                      zenburn-bg+1))) ; old emacsen
              (t :weight bold)))
;;;;; hl-sexp
