     ...
     (let* ((last-time (current-time))
            (org-file
             (expand-file-name
              ...
              starter-kit-dir))
            (elisp-file
             (expand-file-name (format "%s.el" (file-name-base org-file)))))
       (if (or
...
(starter-kit-fast-load "occur")
(starter-kit-fast-load "gud")
(starter-kit-fast-load "midnight")
...
(starter-kit-fast-load "cmake")
(starter-kit-fast-load "rst")
(starter-kit-fast-load "fortran")
(starter-kit-fast-load "latex")
(starter-kit-fast-load "graphviz")
(starter-kit-fast-load "rnc")
(starter-kit-fast-load "cc")
(starter-kit-fast-load "js")
;; load flyspell at last so that aspell will not start when
;; org-babel-load-file which is very time consuming
